...
const Learn = () => {
    ...
    const handleDecrement = () => {
        if (count == 0) {
            return setCount('cant decrement count is zero')
        }
        setCount(count - 1)
    }
    const data = [
    ...
    return (
        <div className="App">
            ...
            <button className='mt-3 mr-1' onClick={handleIncrement}>Increment</button>
            <button className='mt-3 ml-1' onClick={handleDecrement}>Decrement</button>
        </div >
    )
}
